      ...
      <div class="leftContentParent" style="width: 70%">
        <div class="halfContent" style="flex: 0 0 83.2%">
          ...
          <ul>
            ...
            <li>The amount of power generated from solar and wind changes due to the weather and can’t be relied upon.</li>
            ...
            <li>Nuclear power stations use <strong>fission</strong> where the centre of an atom breaks up into two or more smaller pieces. The broken pieces hit other atoms causing a chain reaction releasing energy.</li>
          </ul>
        </div>
      </div>
    </div>
